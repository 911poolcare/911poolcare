...
const LEAK_FIELD_PHOTOS: FieldPhotoSpec[] = [
  {
    file: "field-austin-dye-testing.jpg",
    citySlug: "austin",
    cityName: "Austin",
  ...
  {
    file: "field-austin-return-fitting.jpg",
    citySlug: "austin",
    cityName: "Austin",
  ...
  {
    file: "field-westlake-electronic-detection.jpg",
    citySlug: "westlake",
    cityName: "Westlake",
  ...
  {
    file: "field-lakeway-old-fitting.jpg",
    citySlug: "lakeway",
    cityName: "Lakeway",
  ...
  {
    file: "field-lakeway-pool-deck-dig.jpg",
    citySlug: "lakeway",
    cityName: "Lakeway",
  ...
  {
    file: "field-georgetown-deck-excavation.jpg",
    citySlug: "georgetown",
    cityName: "Georgetown",
  ...
  {
    file: "field-georgetown-diver-detection.jpg",
    citySlug: "georgetown",
    cityName: "Georgetown",
  ...
  {
    file: "field-georgetown-pipe-leak.jpg",
    citySlug: "georgetown",
    cityName: "Georgetown",
  ...
  {
    file: "field-georgetown-deck-cut.jpg",
    citySlug: "georgetown",
    cityName: "Georgetown",
  ...
  {
    file: "field-georgetown-deck-dig.jpg",
    citySlug: "georgetown",
    cityName: "Georgetown",
  ...
  {
    file: "field-georgetown-underground-repair.jpg",
    citySlug: "georgetown",
    cityName: "Georgetown",
  ...
  {
    file: "field-georgetown-cracked-pvc.jpg",
    citySlug: "georgetown",
    cityName: "Georgetown",
  ...
  {
    file: "field-leander-underground-repair.jpg",
    citySlug: "leander",
    cityName: "Leander",
  ...
  {
    file: "field-leander-deck-excavation.jpg",
    citySlug: "leander",
    cityName: "Leander",
  ...
  {
    file: "field-leander-leakalyzer-setup.jpg",
    citySlug: "leander",
    cityName: "Leander",
  ...
  {
    file: "field-leander-shell-crack.jpg",
    citySlug: "leander",
    cityName: "Leander",
  ...
  {
    file: "field-round-rock-return-fitting.jpg",
    citySlug: "round-rock",
    cityName: "Round Rock",
  ...
  {
    file: "field-round-rock-pressure-testing.jpg",
    citySlug: "round-rock",
    cityName: "Round Rock",
  ...
  {
    file: "field-round-rock-pipe-camera.jpg",
    citySlug: "round-rock",
    cityName: "Round Rock",
  ...
  {
    file: "field-liberty-hill-dye-testing.jpg",
    citySlug: "liberty-hill",
    cityName: "Liberty Hill",
  ...
  {
    file: "field-liberty-hill-underground-repair.jpg",
    citySlug: "liberty-hill",
    cityName: "Liberty Hill",
  ...
  {
    file: "field-dripping-springs-tile-separation.jpg",
    citySlug: "dripping-springs",
    cityName: "Dripping Springs",
  ...
  {
    file: "field-dripping-springs-spa-cracks.jpg",
    citySlug: "dripping-springs",
    cityName: "Dripping Springs",
  ...
  {
    file: "field-dripping-springs-diver-inspection.jpg",
    citySlug: "dripping-springs",
    cityName: "Dripping Springs",
  ...
  {
    file: "field-spicewood-crack-at-rockwork.jpg",
    citySlug: "spicewood",
    cityName: "Spicewood",
  ...
  {
    file: "field-spicewood-structural-crack.jpg",
    citySlug: "spicewood",
    cityName: "Spicewood",
  ...
  {
    file: "field-spicewood-pressure-testing-setup.jpg",
    citySlug: "spicewood",
    cityName: "Spicewood",
  ...
  {
    file: "field-lago-vista-dye-supplies.jpg",
    citySlug: "lago-vista",
    cityName: "Lago Vista",
  ...
  {
    file: "field-lago-vista-skimmer-gap.jpg",
    citySlug: "lago-vista",
    cityName: "Lago Vista",
  ...
  {
    file: "field-lago-vista-pressure-testing.jpg",
    citySlug: "lago-vista",
    cityName: "Lago Vista",
  ...
  {
    file: "field-pflugerville-underground-line.jpg",
  ...
  {
    file: "field-cedar-park-electronic-detection.jpg",
    citySlug: "cedar-park",
    cityName: "Cedar Park",
  ...
  {
    file: "field-cedar-park-underwater-inspection.jpg",
    citySlug: "cedar-park",
    cityName: "Cedar Park",
...
function buildEquipmentJob({
  ...
  return {
    ...
    images: stages.map((stage) => {
      const stageLabel = stage.charAt(0).toUpperCase() + stage.slice(1);
      return {
        src: `/images/jobs/pool-equipment-repair/curated-${citySlug}-${jobKey}-${stage}.jpg`,
        kind: "image" as const,
...
function buildLeakRepairJob({
  ...
  return {
    ...
    images: [
      {
        src: `/images/jobs/pool-leak-detection/curated-${citySlug}-repair${suffix}-before.jpg`,
        kind: "image",
        alt: `${cityName} underground pipe leak — before repair`,
        caption: "Before",
      },
      {
        src: `/images/jobs/pool-leak-detection/curated-${citySlug}-repair${suffix}-after.jpg`,
        kind: "image",
...
const INSPECTION_FIELD_PHOTOS: FieldPhotoSpec[] = [
  {
    file: "curated-cedar-park-inspection-01.jpg",
    citySlug: "cedar-park",
    cityName: "Cedar Park",
  ...
  {
    file: "field-leander-inspection-fill.jpg",
    citySlug: "leander",
    cityName: "Leander",
  ...
  {
    file: "field-leander-inspection-tile.jpg",
    citySlug: "leander",
    cityName: "Leander",
